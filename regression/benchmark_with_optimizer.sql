-- Benchmark Queries: With Join Optimizer
-- =========================================================================
-- Run these queries with join_optimizer.enabled = on

\echo '============================================================='
\echo 'BENCHMARK WITH JOIN OPTIMIZER (join_optimizer.enabled = on)'
\echo '============================================================='
...
SHOW join_optimizer.algorithm;
SHOW join_optimizer.dp_threshold;
SHOW join_optimizer.greedy_threshold;
...
\echo ''
\echo '--- Collected Join Statistics ---'
SELECT table1_name, table2_name, actual_rows, actual_time_ms, selectivity
